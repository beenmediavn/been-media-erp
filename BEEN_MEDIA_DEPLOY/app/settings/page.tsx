...
export default function SettingsPage(){
 ...
 return <MainLayout><div className="mx-auto max-w-5xl"><div className="mb-6"><h1 className="text-3xl font-bold bm-gold">Cài đặt</h1><p className="bm-muted">Cấu hình hệ thống, nhận diện và bảo mật BEEN MEDIA ERP.</p></div>
  <div className="space-y-4">
   ...
   <section className="grid gap-4 sm:grid-cols-2"><div className="bm-card rounded-3xl p-5"><WifiOff className="mb-2 bm-gold"/><b>Offline / PWA</b><p className="mt-1 text-sm bm-muted">Có thể cài app lên màn hình chính. Khi mất mạng, Job được giữ bản nháp cục bộ để không mất thông tin; khi có mạng mở lại và đồng bộ.</p></div><div className="bm-card rounded-3xl p-5"><Sparkles className="mb-2 bm-gold"/><b>AI (tùy chọn)</b><p className="mt-1 text-sm bm-muted">AI đang tạm ẩn để ưu tiên vận hành ERP ổn định. Khi cần, chỉ việc bật lại biến ENABLE_AI/NEXT_PUBLIC_ENABLE_AI và cấu hình API; không phải làm lại app.</p></div></section>
  </div>
 </div></MainLayout>
}
